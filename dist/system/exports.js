  ...
  return {
    setters: [function (_autocompleteAutocomplete) {
      ...
      for (var _key54 in _toastToastService) {
        if (_key54 !== "default" && _key54 !== "__esModule") _exportObj54[_key54] = _toastToastService[_key54];
      }
      ...
      for (var _key55 in _tooltipTooltip) {
        if (_key55 !== "default" && _key55 !== "__esModule") _exportObj55[_key55] = _tooltipTooltip[_key55];
      }
      ...
      for (var _key56 in _transitionsFadeinImage) {
        if (_key56 !== "default" && _key56 !== "__esModule") _exportObj56[_key56] = _transitionsFadeinImage[_key56];
      }
      ...
      for (var _key57 in _transitionsStaggeredList) {
        if (_key57 !== "default" && _key57 !== "__esModule") _exportObj57[_key57] = _transitionsStaggeredList[_key57];
      }
      ...
      for (var _key58 in _validationValidationRenderer) {
        if (_key58 !== "default" && _key58 !== "__esModule") _exportObj58[_key58] = _validationValidationRenderer[_key58];
      }
      ...
      for (var _key59 in _wavesWaves) {
        if (_key59 !== "default" && _key59 !== "__esModule") _exportObj59[_key59] = _wavesWaves[_key59];
      }
